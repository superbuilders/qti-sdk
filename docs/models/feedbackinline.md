...
```typescript
import { FeedbackInline } from "qti";

let value: FeedbackInline = {
...
| `showHide`                                                                                                                                                                               | [models.FeedbackInlineShowHide](../models/feedbackinlineshowhide.md)                                                                                                                     | :heavy_check_mark:                                                                                                                                                                       | Determines the feedback visibility behavior. 'show' displays the feedback when the outcome variable matches the identifier, 'hide' conceals it when the outcome variable matches.        |
