...
```typescript
import { FeedbackBlockRequest } from "qti/models/operations";

let value: FeedbackBlockRequest = {
...
| `showHide`                                                                                                                                                                               | [operations.FeedbackBlockShowHideRequest](../../models/operations/feedbackblockshowhiderequest.md)                                                                                       | :heavy_check_mark:                                                                                                                                                                       | Determines the feedback visibility behavior. 'show' displays the feedback when the outcome variable matches the identifier, 'hide' conceals it when the outcome variable matches.        |
