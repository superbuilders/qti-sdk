# GetAllQuestionsResponseDeclarationBaseType
...
```typescript
import { GetAllQuestionsResponseDeclarationBaseType } from "qti/models/operations";

let value: GetAllQuestionsResponseDeclarationBaseType = "duration";
```
