# ResponseDeclarationBaseTypeRequest
...
```typescript
import { ResponseDeclarationBaseTypeRequest } from "qti/models/operations";

let value: ResponseDeclarationBaseTypeRequest = "integer";
```
