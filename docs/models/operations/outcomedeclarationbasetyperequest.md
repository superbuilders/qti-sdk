# OutcomeDeclarationBaseTypeRequest
...
```typescript
import { OutcomeDeclarationBaseTypeRequest } from "qti/models/operations";

let value: OutcomeDeclarationBaseTypeRequest = "string";
```
